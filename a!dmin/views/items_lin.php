...
<table id="dataTable" class="table  table-bordered table-hover table-responsive">
        ...
        <?php foreach ($items as $i):?>
			...
			<td><?=$v?></td>
            <?php endforeach ?>
           <td id="buttonTh"><a class="btn btn-danger" href="../services/items_lin.php/?action=delete&game=<?php echo $game?>&id=<?php echo $i['id']?>" >Delete</a>
            </td>
            </tr>
             <?php endforeach ?>
        </tbody>
...
<div id="itemsModal" class="modal fade " tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog " role="document" >
        <div class="modal-content">
            ...
            <form method="post" action="../services/items_lin.php/?action=add&game=<?php echo $game?>">
